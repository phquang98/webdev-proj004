...
export class UserResolver {
  ...
  async login(@Arg("loginInputNe") loginInput: LoginInput, @Ctx() { req }: TContext): Promise<UserMutationResponse> {
    try {
      ...
      req.session.userId = tryToLoginUser.id;
      // console.log("baby why", req.session);
